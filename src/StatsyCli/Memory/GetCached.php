 ...
 */
class GetCached implements Command
{
    /**
     * @var Memory
     */
     ...
     * Runs the command
     *
     * This command is returning the value of cached memory in bytes from the system.
     *
     * @return void
     */
