 ...
 */
class GetShMem implements Command
{
    /**
     * @var Memory
     */
     ...
     * Runs the command
     *
     * This command is returning the value of shared memory in bytes from the system.
     *
     * @return void
     */
